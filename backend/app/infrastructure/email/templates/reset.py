def render_reset_email(*, name: str, link: str, origin: str) -> str:
    ...
    <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0;">
      ...
      <tr><td style="padding:32px;">
        ...
        <p style="color:#475569;font-size:14px;margin:0 0 20px;">
          Se ha solicitado un restablecimiento de contraseña para tu cuenta. Haz clic en el siguiente enlace para crear una nueva contraseña:
        </p>
        <table cellpadding="0" cellspacing="0" style="margin:24px auto;"><tr>
          <td style="background:#2563eb;border-radius:6px;padding:0;">
            <a href="{link}" style="display:inline-block;padding:12px 32px;color:#ffffff;text-decoration:none;font-weight:600;font-size:14px;">Crear nueva contraseña</a>
          </td>
        </tr></table>
