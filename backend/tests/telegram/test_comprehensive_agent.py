...
# ═══════════════════════════════════════════════════════════════════════════
# SQLite adaptation helpers
# ═══════════════════════════════════════════════════════════════════════════

# Map of PostgreSQL → SQLite transformations for templates
PG_TO_SQLITE_REPLACEMENTS = {
    "TRUE": "1",
    "FALSE": "0",
    "ILIKE": "LIKE",
...
def _to_sqlite(sql: str) -> str:
    ...
    result = sql
    # Order matters: do FALSE before TRUE to avoid partial matches
    for pg, sq in PG_TO_SQLITE_REPLACEMENTS.items():
...
@pytest.fixture
def router_with_real_templates(seeded_db):
    """IntentRouter con los DEFAULT_QUERY_TYPES reales adaptados a SQLite."""
    registry = QueryRegistry()
    for entry in DEFAULT_QUERY_TYPES:
        registry.register(
            query_type=entry["query_type"],
            sql_template=_to_sqlite(entry["sql_template"]),
...
@pytest.fixture
def agent_with_real_templates(seeded_db, router_with_real_templates):
    """ConversationalAgent con router real y FakeLLMProvider."""
    llm = FakeLLMProvider()
    return ConversationalAgent(llm=llm, router=router_with_real_templates)
...
class TestAllQueryTypes:
    ...
    # ── count_doctors_total ──
    def test_count_doctors_total(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    # ── count_by_sex ──
    def test_count_by_sex(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    # ── doctors_by_sex ──
    def test_doctors_by_sex_male(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_doctors_by_sex_female(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    # ── count_by_rank ──
    def test_count_by_rank(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_count_by_specific_rank_cabo(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_count_by_specific_rank_sargento(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    # ── doctors_by_rank ──
    def test_doctors_by_rank(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    # ── list_active_doctors ──
    def test_list_active_doctors(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    # ── doctor_detail ──
    def test_doctor_detail_by_search(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_doctors_pending_availability(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_calendar_status_month(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_doctors_working_date(self, router_with_real_templates) -> None:
    ...
    def test_assignment_count_by_date_range(self, router_with_real_templates) -> None:
        today = date.today()
    ...
    # ── mission_ranking ──
    def test_mission_ranking(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    # ── operational_summary ──
    def test_operational_summary(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    # ── doctor_history_60d ──
    def test_doctor_history_60d(self, router_with_real_templates, seeded_db) -> None:
    ...
    def test_count_doctors_by_department(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_count_by_specific_sex(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_doctor_history_by_name(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    # ── assignments_by_area ──
    def test_assignments_by_area(self, router_with_real_templates) -> None:
        today = date.today()
        start = today.strftime("%Y-%m-%d")
    ...
    def test_unresolved_gaps_month(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
...
class TestExports:
    ...
    def test_export_pdf_list_active_doctors(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_export_excel_list_active_doctors(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
            action="export", query_type="list_active_doctors", params={},
    ...
    def test_export_pdf_count_by_sex(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_export_pdf_mission_ranking(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_export_pdf_operational_summary(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_export_pdf_doctors_pending_availability(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_export_pdf_doctors_by_rank(self, router_with_real_templates) -> None:
        result = router_with_real_templates.handle(
    ...
    def test_export_pdf_assignments_by_area(self, router_with_real_templates) -> None:
        today = date.today()
        result = router_with_real_templates.handle(
    ...
    def test_export_empty_returns_graceful(self, router_with_real_templates) -> None:
...
class TestFallbackAndEdgeCases:
    ...
    def test_unknown_query_type_returns_not_found(self, router_with_real_templates) -> None:
    ...
    def test_empty_params_still_works(self, router_with_real_templates) -> None:
    ...
    def test_invalid_action_returns_fallback(self, router_with_real_templates) -> None:
    ...
    def test_query_with_nonexistent_param_value(self, router_with_real_templates) -> None:
    ...
    def test_export_without_format_defaults_to_pdf(self, router_with_real_templates) -> None:
    ...
    def test_reply_action_does_not_touch_db(self, router_with_real_templates) -> None:
    ...
    def test_ambiguous_action_uses_llm_text(self, router_with_real_templates) -> None:
    ...
    def test_ambiguous_falls_back_to_default(self, router_with_real_templates) -> None:
    ...
    def test_router_handles_sql_injection_attempt(self, router_with_real_templates) -> None:
...
class TestAgentPipeline:
    ...
    def test_agent_query_action_through_pipeline(self, seeded_db, router_with_real_templates) -> None:
        """FakeLLM → Agent.process() → query → respuesta con datos reales."""
        llm = FakeLLMProvider(responses={
            "cuantos": '{"action": "query", "query_type": "count_doctors_total", "params": {}}',
        })
        agent = ConversationalAgent(llm=llm, router=router_with_real_templates)
        result = agent.process(text="cuantos medicos hay")
        assert result.agent_action == "query"
        assert "encontrar" not in result.response_text.lower()

    def test_agent_export_action_through_pipeline(self, seeded_db, router_with_real_templates) -> None:
    ...
    def test_agent_reply_action_through_pipeline(self, seeded_db, router_with_real_templates) -> None:
    ...
    def test_agent_low_confidence_triggers_clarification(self, seeded_db, router_with_real_templates) -> None:
    ...
    def test_agent_missing_fields_triggers_prompt(self, seeded_db, router_with_real_templates) -> None:
    ...
    def test_agent_validation_error_handled(self, seeded_db, router_with_real_templates) -> None:
    ...
    def test_agent_non_json_response_treated_as_direct(self, seeded_db, router_with_real_templates) -> None:
...
class TestRegistryIntegrity:
    ...
    def test_all_20_templates_registered(self, router_with_real_templates) -> None:
        expected = {
        ...
        registered = {e["query_type"] for e in router_with_real_templates.registry.list_all()}
        missing = expected - registered
        assert not missing, f"Faltan templates: {missing}"

    def test_all_templates_have_export_filename(self, router_with_real_templates) -> None:
